...
## 2. Import and Use in Your Code (Short Import)
...
## 3. Custom Strategies
You can subclass `bt.Simulator` to override trading logic for more advanced strategies (see below for an example).
